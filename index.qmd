...
::: {.callout-important}
## This is important 
The midterm will take place on Week 7 during the lecture's slot. There will be no lecture on that week.
:::
...
library(tidyverse)
gs4_deauth()
d <- read_sheet("https://docs.google.com/spreadsheets/d/1MuCNeWbDy5LuHVeVvCXVowXTPmzexdy0uR6lkGJqMHQ/edit?usp=sharing") 
```
