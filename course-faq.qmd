...
You can use either R or Python. We will be providing code examples in R and suppport in both languages.
...
We will be using Github-classroom (or an equivalent GitHub-related) service to distribute and collect assignments. You will need to create a Github account if you don't already have one.
