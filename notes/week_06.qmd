...
Sigma[Ind==1] <- 1
levelplot(t(as.matrix(mu)),main="mu_n_obs", colorkey = FALSE, ylab = list("i=1,...,p", cex = 0.7), xlab = " ", sub=" ", pretty=TRUE)
levelplot(Sigma, main="Sigma_n_obs", colorkey = FALSE, ylab = list("i=1,...,p", cex = 0.7), xlab = list("i=1,...,p", cex = 0.7), sub=" ", pretty=TRUE)
```
