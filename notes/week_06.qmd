...
Sigma[Ind == 1] <- 1
levelplot(t(as.matrix(mu)), main = list(TeX("$\\mu^{(n)}_{obs}$"), cex = 1.5), colorkey = FALSE, ylab = list("i=1,...,p", cex = 1), xlab = " ", sub = " ", pretty = TRUE)
levelplot(Sigma, main = list(TeX("$\\Sigma^{(n)}_{obs}$"), cex = 1.5), colorkey = FALSE, ylab = list("i=1,...,p", cex = 1), xlab = list("i=1,...,p", cex = 1), sub = " ", pretty = TRUE)
```
