...
We will use GitHub Classroom to handle the assignments and the project for this course. See [this page](resources/tutorials/github_classroom.qmd) for more information on how to use GitHub Classroom.
